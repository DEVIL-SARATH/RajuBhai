...
${chalk.blue.italic('ℹ️ Connecting to WhatsApp...')}`);
    ...
    conn.on('open', async () => {
        ...
        console.log(
            chalk.green.bold('😇RAJUBHAI BOT working😈!')
        );
        ...
        if (config.WORKTYPE == 'public') {
            if (config.LANG == 'TR' || config.LANG == 'AZ') {
                ...
                if (conn.user.jid === '@s.whatsapp.net') {
                    ...
                    await conn.sendMessage(conn.user.jid, '🤖𝐑𝐀𝐉𝐔𝐁𝐇𝐀𝐈 𝐒𝐓𝐀𝐑𝐓𝐄𝐃🤖*', MessageType.text);
                }
            }
            else {
                ...
                if (conn.user.jid === '@s.whatsapp.net') {
                    ...
                    await conn.sendMessage(conn.user.jid, '♥️𝐑𝐀𝐉𝐔𝐁𝐇𝐀𝐈 𝐒𝐓𝐀𝐑𝐓𝐄𝐃♥️', MessageType.text);
                }
...
*/
                        try {
                            ...
                            if (config.LANG == 'TR' || config.LANG == 'AZ') {
                                ...
                                await conn.sendMessage(conn.user.jid, '*~_________~ *RajuBhai ERROR FOUND!* ~______~*' +
